...
//远程异步读取三个大型单词文本
 ...
 UI.showStatistics = function() {
    let easy = 0, known = 0, unknown = 0;
    ...
    let statsMessage = `${Model.user}学习的信息如下：\n熟悉：${easy}\n知道：${known}\n陌生：${unknown}`;
    UI.response(statsMessage);
  ...
  UI.footerLog = function(s){
    ...
    setTimeout(() => {
        select('footer').textContent = "江西科技师范大学 郑坤翔 2024--2025" ;
    }, 3*1000);
  };
